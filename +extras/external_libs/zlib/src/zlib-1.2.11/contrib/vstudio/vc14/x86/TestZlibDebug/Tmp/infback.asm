; Listing generated by Microsoft (R) Optimizing Compiler Version 19.14.26428.1 
	...
	TITLE	C:\Users\dkovari\Documents\GitHub\ExtrasToolbox\+extras\external_libs\zlib\src\zlib-1.2.11\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG92793 DB	'1.2.11', 00H
	ORG $+1
$SG93179 DB	'invalid block type', 00H
	ORG $+1
$SG93184 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG93196 DB	'too many length or distance symbols', 00H
$SG93200 DB	'invalid code lengths set', 00H
	ORG $+3
$SG93211 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG93219 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG93222 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG93224 DB	'invalid literal/lengths set', 00H
$SG93226 DB	'invalid distances set', 00H
	ORG $+2
$SG93242 DB	'invalid literal/length code', 00H
$SG93254 DB	'invalid distance code', 00H
	ORG $+2
$SG93259 DB	'invalid distance too far back', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\dkovari\documents\github\extrastoolbox\+extras\external_libs\zlib\src\zlib-1.2.11\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG92793[edx]
	cmp	eax, ecx
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93179
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93184
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93196
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93200
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93211
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93219
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93222
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93224
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG93226
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93242
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93254
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG93259
