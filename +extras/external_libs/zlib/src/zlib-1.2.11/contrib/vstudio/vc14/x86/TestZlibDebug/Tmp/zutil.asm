; Listing generated by Microsoft (R) Optimizing Compiler Version 19.14.26428.1 
	...
	TITLE	C:\Users\dkovari\Documents\GitHub\ExtrasToolbox\+extras\external_libs\zlib\src\zlib-1.2.11\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
$SG96307 DB	'need dictionary', 00H
$SG96308 DB	'stream end', 00H
	ORG $+1
$SG96310 DB	'file error', 00H
	ORG $+1
$SG96311 DB	'stream error', 00H
	ORG $+3
$SG96312 DB	'data error', 00H
	ORG $+1
$SG96313 DB	'insufficient memory', 00H
$SG96314 DB	'buffer error', 00H
	ORG $+3
$SG96315 DB	'incompatible version', 00H
_DATA	ENDS
CONST	SEGMENT
_z_errmsg DD	FLAT:$SG96307
	DD	FLAT:$SG96308
	DD	FLAT:$SG96309
	DD	FLAT:$SG96310
	DD	FLAT:$SG96311
...
_DATA	SEGMENT
	ORG $+3
$SG96318 DB	'1.2.11', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\dkovari\documents\github\extrastoolbox\+extras\external_libs\zlib\src\zlib-1.2.11\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
