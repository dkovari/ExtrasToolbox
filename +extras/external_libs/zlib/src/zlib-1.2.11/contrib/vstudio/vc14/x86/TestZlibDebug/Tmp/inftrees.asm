; Listing generated by Microsoft (R) Optimizing Compiler Version 19.14.26428.1 
	...
	TITLE	C:\Users\dkovari\Documents\GitHub\ExtrasToolbox\+extras\external_libs\zlib\src\zlib-1.2.11\inftrees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\dkovari\documents\github\extrastoolbox\+extras\external_libs\zlib\src\zlib-1.2.11\inftrees.c
_TEXT	SEGMENT
_offs$ = -148						; size = 32
_count$ = -116						; size = 32
_mask$ = -84						; size = 4
