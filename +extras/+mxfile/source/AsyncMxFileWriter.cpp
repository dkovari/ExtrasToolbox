...
extras::SessionManager::ObjectManager<extras::mxfile::AsyncMxFileWriter> manager;
extras::mxfile::AsyncMxFileWriterInterface<extras::mxfile::AsyncMxFileWriter, manager> mex_interface; //create interface manager for the MxFileReader
