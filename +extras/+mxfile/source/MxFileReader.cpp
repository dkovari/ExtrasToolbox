...
extras::SessionManager::ObjectManager<extras::mxfile::MxFileReader> manager;
extras::mxfile::MxFileReaderInterface<extras::mxfile::MxFileReader, manager> mex_interface; //create interface manager for the MxFileReader
