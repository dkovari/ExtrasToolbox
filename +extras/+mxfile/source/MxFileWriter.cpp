...
extras::SessionManager::ObjectManager<extras::mxfile::MxFileWriter> manager;
extras::mxfile::MxFileWriterInterface<extras::mxfile::MxFileWriter,manager> mex_interface; //create interface manager for the MxFileWriter
