classdef MxFileWriter < extras.SessionManager.Session
%% extras.mxfile.MxFileWriter
% Interface to Mex-based system for writing data to mxf.gz type files.
