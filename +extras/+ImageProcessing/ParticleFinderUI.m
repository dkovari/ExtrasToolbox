classdef ParticleFinderUI < extras.RequireGuiLayoutToolbox & ...
    ...
    %% constructor
    methods
        function this = ParticleFinderUI(stack_cell,varargin)
        ...
        %   ParticleFinderUI(stack_cell,Name,Value)
            ...
            this@extras.GraphicsChild(@() figure('Name','Particle Finder','NumberTitle','off'));
            this.CheckParentInput();
            
            %% Create viewer for stack
            this.Viewer = extras.stackviewer(this.Parent,stack_cell);
            ...
            this.ControlsFigure = figure('MenuBar','none',...
                ...
                'NumberTitle','off',...
                'CloseRequestFunction',@(~,~) warning('Cannot close Partcile Finder Controls. Close main viewer instead'),...
            ...
            pos(3) = MinWidth+40;
            pos(4) = min(500,this.OuterScrollBox.MinimumHeights+40);
