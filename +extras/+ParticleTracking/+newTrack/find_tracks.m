...
% Links together xy coordinates into xy-t traces
% Input:
%   P: cell array of XY point positions
%       each cell corresponds to a different frame
%       typically each cell is the output of an image particle
%       identification function (like pkfnd() or radialcenter()).
