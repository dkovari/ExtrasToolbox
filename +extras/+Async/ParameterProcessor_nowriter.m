classdef ParameterProcessor_nowriter < extras.Async.AsyncProcessor & dynamicprops
% Base class for all ParameterProcessor_nowriter type AsyncProcessors
%% Copyright 2019 Daniel T. Kovari, Emory University
%   All rights reserved.

    %% create
    methods
        function this = ParameterProcessor_nowriter(MEX_FUNCTION)
            this@extras.Async.AsyncProcessor(MEX_FUNCTION)
            this.Name = 'ParameterProcessor_nowriter'; %Change Name
