classdef (Abstract) ResultsWriter < handle
% Mixin class for AsyncProcessor Objects which also include the integrated
% results writer functionality.
%% Copyright 2020 Daniel T. Kovari
% All rights reserved.

    %% FORCE ABSTRACT INHERET
    methods (Abstract)
        varargout = runMethod(this,varargin)
    end
    %% Properties, defined in AsyncProcessor
    properties (Abstract)
    ...
    methods
        function this = ResultsWriter()
            ...
            this.ResultsWriterErrorTimer = timer('ObjectVisibility','off',...
                                     ...
                                     'Name','AsyncProcessorWithWriter-ResultsWriterErrorTimer',...
             ...
             this.ResultsWriterCheckTimer = timer('ObjectVisibility','off',...
                                        'BusyMode','drop',...
                                        'ExecutionMode','fixedSpacing',...
                                        'Name','AsyncProcessorWithWriter-ResultsWriterCheckTimer',...
