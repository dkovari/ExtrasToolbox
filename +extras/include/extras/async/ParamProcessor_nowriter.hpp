...
namespace extras {
	namespace async {
		...
		class ParamProcessor_nowriter : public AsyncProcessor {
		private:
			/////////////////////////////////
		...
		public:
			...
			virtual ~ParamProcessor_nowriter() {
#ifdef _DEBUG
		...
		template<class ObjType, extras::SessionManager::ObjectManager<ObjType>& ObjManager> /*ObjType should be a derivative of ParamProcessor_nowriter*/
		class ParamProcessor_nowriterInterface :public extras::async::AsyncMexInterface<ObjType, ObjManager> {
		...
		public:
			ParamProcessor_nowriterInterface() {
				using namespace std::placeholders;
				ParentType::addFunction("setParameters", std::bind(&ParamProcessor_nowriterInterface::setParameters, this, _1, _2, _3, _4));
				ParentType::addFunction("clearParameters", std::bind(&ParamProcessor_nowriterInterface::clearParameters, this, _1, _2, _3, _4));
				ParentType::addFunction("getParameters", std::bind(&ParamProcessor_nowriterInterface::getParameters, this, _1, _2, _3, _4));
			}
		};
