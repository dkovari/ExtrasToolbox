...
template<typename resultsT=double, class resultsArrayClass=NativeArray<resultsT>,
		typename locT=size_t, class locArrayClass=NativeArray<locT>,
		typename countT=size_t, class countArrayClass=NativeArray<countT>,
        typename M=double>
std::tuple<resultsArrayClass,locArrayClass, countArrayClass>
radialavg(const TypedArrayI<M>& I, double x0, double y0, double Rmax = NAN, double Rmin = 0, double BinWidth = 1,bool computeRloc = true){
